...
/** @defgroup HAL_Private_Constants HAL Private Constants
  ...
  */
/**
 * @brief HW32L003 HAL Driver version number V1.0.0
   */
#define __HW32L003_HAL_VERSION_MAIN   (0x01U) /*!< [31:24] main version */
#define __HW32L003_HAL_VERSION_SUB1   (0x00U) /*!< [23:16] sub1 version */
#define __HW32L003_HAL_VERSION_SUB2   (0x00U) /*!< [15:8]  sub2 version */
#define __HW32L003_HAL_VERSION_RC     (0x00U) /*!< [7:0]  release candidate */
#define __HW32L003_HAL_VERSION         ((__HW32L003_HAL_VERSION_MAIN << 24)\
                                        |(__HW32L003_HAL_VERSION_SUB1 << 16)\
                                        |(__HW32L003_HAL_VERSION_SUB2 << 8 )\
                                        |(__HW32L003_HAL_VERSION_RC))
...
/**
  ...
  *           "HW32l003_hal_msp.c" to do the global low level hardware initialization
  *
...
{
  return __HW32L003_HAL_VERSION;
}

/**
  * @brief Returns the device revision identifier.
  * Note: 
  *       Address 0x180000F0-0x180000FF are unique ID for HW32L003.
